<template>
  <view>
    ...
    <view class="home_content" :style="{ paddingTop: ht + 'px' }" @touchmove.stop.prevent="disabledScroll">
      ...
      <view class="restaurant_info_box">
        <view class="restaurant_info">
            ...
            <view class="info_top_right">
              ...
              <view class="right_details">
                ...
                <view class="details_flex">
                  ...
                  <text class="icon_text">预计30分钟内送达</text>
                </view>
              </view>
            </view>
          </view>
          ...
          <view class="info_bottom">
            <view>
              <view class="word">面向社区用户的即时零售商品选购与下单服务</view>
              <view class="promo_row">
                <text class="promo_tag">今日团购</text>
                <text class="promo_tag">限时秒送</text>
                <text class="promo_tag">社区优选</text>
                <text class="promo_tag">邻里热卖</text>
              </view>
              <view class="address">
                <icon></icon>
                {{ shopInfo().shopAddress || "门店地址获取中.." }}
              </view>
            </view>
            <view>
        ...
        <scroll-view class="vegetable_order_list" scroll-y="true" scroll-top="0rpx"
          ...
          <view class="type_item" v-for="(item, index) in dishListItems" :key="index">
            ...
            <view class="dish_info">
              ...
              <view class="dish_label" @click="openDetailHandle(item)">社区优选商品</view>
      ...
      <view class="restaurant_close" v-if="shopStatus !== 1">当前门店暂停营业</view>
      <!-- end -->
