...
import OrderDetail from "./components/orderDetail.vue" //商品详情
	...
	methods: {
		...
		handlePhone(type, phone) {
			...
			goCustomerAi(orderInfo) {
				...
				uni.navigateTo({
					url: `/pages/customerAi/index?orderNumber=${encodeURIComponent(orderNumber)}&intent=order_progress`
				})
			},
