  ...
  <div class="dashboard-container">
    <div class="container">
      <div class="tableBar">
        ...
        <div class="tableLab">
          <span v-permission="'product:item:delete'"
                class="delBut non"
          ...
          <span
            ...
            >批量下架</span
          > -->
          <el-button v-permission="'product:item:add'"
                     type="primary"
      ...
      >
        ...
        <el-table-column label="售卖状态">
          <template slot-scope="scope">
            ...
            >
              {{ String(scope.row.status) === '0' ? '已下架' : '已上架' }}
            </div>
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="scope">
            <el-button v-permission="'product:item:edit'"
                       type="text"
                       size="small"
                       class="blueBug"
            ...
            <el-button v-permission="'product:item:delete'"
                       type="text"
                       size="small"
                       class="delBut"
            ...
            <el-button v-permission="'product:item:onoff'"
                       type="text"
                       size="small"
                       class="non"
                       :class="{
...
export default class extends Vue {
  ...
  private statusHandle(row: any) {
    ...
    this.$confirm('确认更改该商品状态?', '提示', {
      ...
      // 上架下架---批量上架下架接口
      productStatusByStatus(this.dishState)
        .then(res => {
          if (res && res.data && res.data.code === 1) {
