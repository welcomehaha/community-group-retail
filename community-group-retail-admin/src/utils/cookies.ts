...
// permissions
const permissionCodesKey = 'permissionCodes';
export const getPermissionCodes = () => Cookies.get(permissionCodesKey);
export const setPermissionCodes = (codes: string[]) => Cookies.set(permissionCodesKey, JSON.stringify(codes || []));
export const removePermissionCodes = () => Cookies.remove(permissionCodesKey);
